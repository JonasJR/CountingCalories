      ...
      if (0 < this.gridCountR)
        for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
          ...
          if ("radar" == b.type) {
            ...
            (L = -A * this.stepWidth / 2) : "date" == this.type && (h = this.axisWidth - h);
          f = !1;
          ...
          m = l = p;
          if (!isNaN(u))
            for (h = 1; h < w; h += u) this.gridAlpha = this.minorGridAlpha, f = p + y * h, f = d.resetDateToMin(new Date(f), z, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
          this.gridAlpha = x
        }
    },
      ...
      if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
        ...
        if (this.autoGridCount || 0 !== this.gridCount)
          if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw();
            ...
            for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), h && r++, g = t; g < r; g += p)
              if (c = x * g + this.minCalc, c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)
                if (isNaN(y) || Number(d.toFixed(c, y)) == c) {
                  ...
                  if (!isNaN(z) && 0 < w && g < r - 1) {
                    t = x / z;
                    h && (z = x * (g + p) + this.minCalc, z = d.roundTo(z, this.maxDecCount + 1), u > this.logGridLimit && (z = Math.pow(10, g + p)), t = 10, z = (z - c) / t);
                    f = this.gridAlpha;
        ...
        if (0 < A) {
          B = this.fillAlpha;
          for (g = this.fillAlpha = 0; g < A; g++) C = u[g], k = NaN, z = C.above, isNaN(C.toValue) || (k = this.getCoordinate(C.toValue), t = new this.axisItemRenderer(this, k, "", !0, NaN, NaN, C), this.pushAxisItem(t, z)), l = NaN, isNaN(C.value) || (l = this.getCoordinate(C.value), t = new this.axisItemRenderer(this, l, C.label, !0, NaN, (k - l) / 2, C), this.pushAxisItem(t, z)), isNaN(k) && (l -= 3, k = l + 3), isNaN(k - l) || (k = new this.guideFillRenderer(this, l, k, C), this.pushAxisItem(k, z), z = k.graphics(), C.graphics = z, C.balloonText && this.addEventListeners(z,
            C));
          this.fillAlpha = B
        }
        g = this.baseValue;
          ...
          if (f.hasOwnProperty(g)) {
            ...
            if (k.includeInMinMax && (!k.hidden || this.includeHidden)) {
              ...
              if (this.minMaxField) l = k[this.minMaxField], l < c && (c = l), l > e && (e = l);
                ...
                for (var m in k) k.hasOwnProperty(m) && "percents" != m && "total" != m && (l = k[m], l < c && (c = l), l > e && (e = l))
            }
          }
      }
      return {
...
(function() {
  ...
  d.RecItem = d.Class({
    construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
      ...
      ba && (ba.attr({
        "text-anchor": ga
      }), ba.translate(G, v, NaN, !0), 0 !== n && ba.rotate(-n, a.chart.backgroundColor), a.allLabels.push(ba), this.label = ba, d.setCN(p, ba, a.bcn + "label"), d.setCN(p, ba, q, !0), g && d.setCN(p, ba, "guide"));
  ...
  d.AmGraph = d.Class({
    ...
    createSerialGraph: function() {
      ...
      var m = this.useNegativeColorIfDown,
        ...
        y = [],
        w = [],
        z, A, B, C, D = this.chart.graphs.length,
        L, I = this.dx / this.tcc,
        S = this.dy /
        this.tcc,
        O = f.stackType,
        Q = this.start,
      ...
      for (K = Q; K <= ia; K++) {
        ...
        if (m && void 0 == this.openField)
          for (var yb = K + 1; yb < e.length && (!e[yb] || !(ab = e[K + 1].axes[f.id].graphs[b]) || !ab.values || (Ta = ab.values.value, isNaN(Ta))); yb++);
        var R, P, J, aa, ja = NaN,
          E = NaN,
          F = NaN,
          N = NaN,
        ...
        if (Ia) {
          ...
          switch (g) {
            case "line":
              if (isNaN(W)) x || (this.drawLineGraph(y, w, U, V), y = [], w = [], U = [], V = []);
              else {
              ...
              break;
            case "smoothedLine":
              if (isNaN(W)) x || (this.drawSmoothedGraph(y, w, U, V), y = [], w = [], U = [], V = []);
              else {
                if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb) y.push(E), w.push(F), jb = E, kb = F;
                wa = E;
                Da = F;
                ...
                la = F;
                !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M));
                void 0 == v.lineColor && void 0 == v.fillColors && isNaN(v.dashLength) || (this.drawSmoothedGraph(y, w, U, V), y = [E], w = [F], U = [], V = [], !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M)), this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors, this.dashLengthSwitched = v.dashLength);
                v.gap && (this.drawSmoothedGraph(y, w, U, V), y = [], w = [], U = [], V = [])
              }
              break;
            case "step":
              if (!isNaN(W)) {
                t ? (isNaN(z) || (y.push(z), w.push(F - xa)), w.push(F - xa), y.push(E), w.push(F + Ga), y.push(E), !Ra || isNaN(M) || isNaN(N) || (isNaN(B) || (U.push(B), V.push(M -
                  xa)), U.push(N), V.push(M - xa), U.push(N), V.push(M + Ga))) : (isNaN(A) || (w.push(A), y.push(E - xa)), y.push(E - xa), w.push(F), y.push(E + Ga), w.push(F), !Ra || isNaN(M) || isNaN(N) || (isNaN(C) || (U.push(N - xa), V.push(C)), U.push(N - xa), V.push(M), U.push(N + Ga), V.push(M)));
                z = E;
                A = F;
                B = N;
                C = M;
    ...
    showGraphBalloon: function(a, b, c, e, h) {
      ...
      if (g && g.enabled && this.showBalloon && !this.hidden) {
        ...
        m && "" !== m ? (e = f.getBalloonColor(this, a), g.drop || (g.pointerOrientation = b), b = a.x, h = a.y, f.rotate && (b = a.y, h = a.x), b += k, h += l, isNaN(b) || isNaN(h) ? this.hideBalloonReal() : (a = this.width, q = this.height, n && g.setBounds(k, l, a +
          k, q + l), g.changeColor(e), g.setPosition(b, h), g.fixPrevious(), g.fixedPosition && (c = !1), !c && "radar" != f.type && (b < k || b > a + k || h < l || h > q + l) ? (g.showBalloon(m), g.hide(0)) : (g.followCursor(c), g.showBalloon(m)))) : (this.hideBalloonReal(), this.resizeBullet(a, e, h))
    ...
    dispatchPanEvent: function() {
      if (this.mouseIsDown) {
        var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3),
          ...
          c = d.roundTo((this.mouse2X - this.mouse2X0) /
            this.width, 3),
      ...
      if (k) {
        ...
        if (n.mouseIsOver) {
          ...
          if (this.resizingLeft) {
            ...
            else if (e = t, e < d && (e = d), isNaN(e) && (e = d), e > q + d && (e = q + d), a = !0 === b ? c - e : l + c - e, 0 > a) this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("x", c + l - d);
            else {
              if (0 === a || isNaN(a)) a = .1;
              g.setAttr("x", e - d);
              g.setAttr("width", a)
    ...
    draw: function() {
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          ...
          n.innerHTML = '<div style="text-align:' + this.textAlign + "; " + D + "max-width:" + this.maxWidth + "px; font-size:" + A + "px; color:" + this.color + "; font-family:" +
            z + '">' + this.text + "</div>";
...
(function() {
  ...
  d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
    ...
    if (0 < l) {
      Q = " M" + y + "," + (z + l) + " L" + A + "," + (B + l);
      x ? (O || (Q += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + A + "," + (B + l) + "," + C + "," + (D + l)), Q += " L" + L + "," + (w + l), 0 < k && (O || (Q += " B" + (b - k) + "," + (l + c - u) + "," + (b + k) + "," +
        (l + c + u) + "," + L + "," + (l + w) + "," + y + "," + (l + z)))) : (Q += " A" + f + "," + g + ",0," + S + ",1," + C + "," + (D + l) + " L" + L + "," + (w + l), 0 < k && (Q += " A" + k + "," + u + ",0," + S + ",0," + y + "," + (z + l)));
      Q += " Z";
      var ia = l;
      x && (ia /= 10);
